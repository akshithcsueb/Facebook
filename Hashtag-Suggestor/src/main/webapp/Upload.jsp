...
.row::after {
 ...
 /*  }  */ 
   ...
   <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v9.0&appId=288101902807985&autoLogAppEvents=1" nonce="O67w0iEg"></script>
    ...
    <div id="form" class="wrapper">
     <h2>HashTag-Suggester</h2>
        ...
        <div class="ways">
            <ul>
                <li class="active" style=color:#bf3436>
                     Upload from Computer
                </li>
                <li style=color:#bf3436>
                     Pick from Facebook
                </li>
            </ul>
        </div>
        ...
        <div class="sections">
            ...
            <div class="file-upload-input,image-upload-wrap" style=color:#bf3436>
  ...
  <input type="file" id="inputfile" class="file-upload,btn" name="myFile" onChange='getFileNameWithExt(event)' style="background-color:#8febe8" required="" />
   <input type="hidden" id="fileName" name="fileName" /> 
  <input style=color:#bf3436  class="btn btn-outline-secondary" style=" border-radius: 1%;" type="submit" value="Upload"/> 
